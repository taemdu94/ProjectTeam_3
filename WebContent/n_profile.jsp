                    ...
                    <div class="card-body">
                        <div class="col-4" style="width: auto;">
                            <div class="d-grid gap-2">&nbsp;
                                <button class="btn btn-secondary" onclick="location.href='./reserve_history.html'" type="button">예약 내역</button>&nbsp;
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <td>
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" readonly value="${n_profile.user_id }">	
                                    <div class="p-3"></div>

                                    <label for="exampleInputEmail1" class="form-label">이름</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="${n_profile.user_name }">	
                                    <div class="p-3"></div>
                                    
                                    <label for="exampleInputEmail1" class="form-label">전화번호</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="${n_profile.user_tel }">
									<div class="p-3"></div>
									
                                    <label for="exampleInputEmail1" class="form-label">이메일</label>
                                    <div class="col input-group">
                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="${n_profile.user_email }">	
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <td>
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" readonly value="${n_profile.n_membership }">
                            </td>
                        </div>
                        <div class="col-3"></div>
                    </div>
