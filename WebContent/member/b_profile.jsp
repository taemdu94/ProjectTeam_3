...
<%
			if(session.getAttribute("login") == "1") {
				...
				%>
				<button type="button" onclick="" class="btn btn-secondary">로그인</button>&nbsp;           
	            <button type="button" onclick="" class="btn btn-secondary">회원가입</button> 
	            <%
			}
%>
            </ul>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="card-body">
                        <div class="col-4" style="width: auto;">
                            <div class="d-grid gap-2">&nbsp;
                                ...
                                <button class="btn btn-secondary" onclick="location.href='member/b_secession.jsp'" type="button">회원탈퇴</button>&nbsp;
                            </div> 
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    ...
                    <form action="B_profileUpdateServlet" method="post">
                            ...
                            <div class="col">
                                <tr>
                                	<td>
	                                    ...
	                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="user_id" readonly value="${b_profile.user_id }">	
                                    </td>
                                    <div class="p-3"></div>
                                    ...
                                    <div style="display: none;" id="hidePwd">
	                                    <td>
	                                    	...
	                                    	<input type="password" class="form-control" aria-describedby="emailHelp" name="member_b_pwd" id="pwd" onchange="check_pwd()">	
	                                    	<span id="check1"></span>
	                                    <div class="p-3"></div>
	                                    </td>
	                                    ...
	                                    <td>
	                                    	...
	                                    	<input type="password" class="form-control" aria-describedby="emailHelp" name="member_b_pwdCheck" id="pw2" onchange="check_pwd()">	
	                                    	<span id="check"></span>
	                    				<div class="p-3"></div>
	                    				</td>
                    				</div>
									...
									<td>
                                    	...
                                    	<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="member_b_name" value="${b_profile.user_name }">	
                                    </td>
                                    <div class="p-3"></div>
                                    
                                    <td>
                                    	<label for="exampleInputEmail1" class="form-label">전화번호</label>
                                    	<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="member_b_tel" value="${b_profile.user_tel }">
									</td>
									<div class="p-3"></div>
									
									<td>
                                    	<label for="exampleInputEmail1" class="form-label">이메일</label>
	                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="member_b_email" readonly value="${b_profile.user_email }">	
                                    </td>
                                    <div class="p-3"></div>
									...
									<div style="display: none;" id="hideEmail">
										<td>
		                                    ...
		                                    <div class="col input-group">
		                                        <input type="text" class="form-control" id="newEmail" aria-describedby="emailHelp" name="member_b_newemail">	
		                                        <button type="button" class="btn btn-primary">인증번호 발송</button>
		                                    </div>
		                                    <div class="p-3"></div>
	
		                                    <div class="col input-group">
		                                        <input type="text" class="form-control" id="emailCheck" aria-describedby="emailHelp" name="member_b_emailCheck">	
