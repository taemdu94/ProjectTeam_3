        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="card-body">
                        <div class="col-4" style="width: auto;">
                            <div class="d-grid gap-2">&nbsp;
                                ...
                                <button class="btn btn-primary" onclick="location.href='member/b_secession.jsp'" type="button">회원탈퇴</button>&nbsp;
                            </div> 
                        </div>
                    </div>
                </div>
                &nbsp;
                    ...
                    <form action="B_deleteIdServlet" method="post">
                            ...
                            <div class="col-5">
                                <tr>
                                    <td>
                                    	...
                                    	<input type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="member_b_pwd">	
                                    </td>
                                    <div class="p-3"></div>
                                </tr>
                            </div>
