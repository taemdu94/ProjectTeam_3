            ...
            <div class="row">
                    ...
                    <div class="card-body">
                        <div class="col-4" style="width: auto;">
                            <div class="d-grid gap-2">&nbsp;
                                ...
                                <button class="btn btn-primary" onclick="location.href='n_secession.jsp'" type="button">회원탈퇴</button>&nbsp;
                            </div> 
                        </div>
                    </div>
                </div>
				...
				<div class="col-6">
	                ...
	                <ul class="nav nav-pills align-items-center">
	                    <button type="button" onclick="location.href='../N_deleteIdServlet'" class="btn btn-secondary">회원 탈퇴</button>&nbsp;           
	                </ul>
          		</div>
