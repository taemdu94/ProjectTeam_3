...
<html lang="ko">
  ...
  <body>
    <form method ="post" action="reservation.do" enctype="multipart/form-data">
    <!-- <header> -->
       ...
       <div class="container">
        <div class="row">
            ...
            <div class="row">
                <div class="col">
                    <ul class="list-group">
                        <li class="list-group-item" style="background-color: skyblue; width: 7rem; "> 방 선택</li>
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                  <th scope="col">방 코드</th>
                                  <th scope="col">방 명칭</th>
                                  <th scope="col">가격</th>
                  ...
                  <div class="col">
                        <ul class="list-group">
                            ...
                            <textarea style="height: 220px;">모든 약관은 스크롤 끝까지 다 내리면 체크박스 체크 되게끔 구현
                            </textarea>
