        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="card-body">
                        <div class="col-4" style="width: auto;">
                            <div class="d-grid gap-2">&nbsp;
                                <button class="btn btn-primary" onclick="location.href='./reserve_history.html'" type="button">예약 내역</button>&nbsp;
                                <button class="btn btn-secondary" onclick="location.href='./n_profile.html'" type="button">회원정보변경</button>&nbsp;
                ...
                <div class="col">
                    ...
                    <h6 class="display-5 fw-normal">취소내역</h6>&nbsp;&nbsp;
                    ...
                    <nav aria-label="Page navigation example">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="card col-3" style="height: 420px;">
                                    <td class="card-body">
                                        <h5 class="card-title fw-bold text-center">취소가게a</h5>
                                        <form action="./예약변경 페이지" method="get">
                                ...
                                <div class="card col-3" style="height: 420px;">
                                    <td class="card-body">
                                        <h5 class="card-title fw-bold text-center">취소가게b</h5>
                                        <form action="./예약변경 페이지" method="get">
                                ...
                                <div class="card col-3" style="height: 420px;">
                                    <td class="card-body">
                                        <h5 class="card-title fw-bold text-center">취소가게c</h5>
                                        <form action="./예약변경 페이지" method="get">
