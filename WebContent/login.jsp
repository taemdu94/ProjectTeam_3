...
<body>   
    <div class="container themed-container" style="background-color: #4598d3;">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                <img src="./img/icon_y_l.png"  class="img" alt="..." height="40" width="40">&nbsp;        
            ...
            <ul class="nav nav-pills">
                ...
                <button type="button" onclick="location.href='LoginServlet'" class="btn btn-secondary">로그인</button>&nbsp;           
    ...
    <main>
        <div class="container col-lg-5">
            ...
            <div class="p-2"></div>
            <div class="findidpwd">
                <a href="FindidServlet">아이디</a>/<a href="FindpwdServlet">패스워드</a>찾기
            </div>
        </div>
